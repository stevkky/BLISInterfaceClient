 ...
 * @author GHSS-BLIS
 */
public class SYSMEXXN1000 extends Thread{
    ...
    public void Stop()
    {
        try {
            ...
            welcomeSocket.close();
//            connSock.close();
             log.AddToDisplay.Display("SYSMEX XN-1000 handler stopped", DisplayMessageType.TITLE);
      ...
      @Override
    public void run() {
        log.AddToDisplay.Display("SYSMEX XN-1000 handler started...", DisplayMessageType.TITLE);
        ...
        try
        {
  		...
  		log.AddToDisplay.Display("Listening on port "+ tcpsettings.PORT+"...",DisplayMessageType.INFORMATION);
                ...
                log.AddToDisplay.Display("SYSMEX XN-1000 is now Connected...",DisplayMessageType.INFORMATION);
                first=false;
                ClientThread client = new ClientThread(connSock,"SYSMEX XN-1000");
                client.start();
                String message ;
		...
		{
                    log.AddToDisplay.Display("SYSMEX XN-1000 client is now disconnected!",DisplayMessageType.WARNING);
                    log.logger.Logger(e.getMessage());
		}
         ...
         try
         {
            ...
            {            
                ...
                {               
                       ...
                       log.AddToDisplay.Display("Sending test with Code: "+SampleList.get(i).aux_id + " to SYSMEX XN-1000",DisplayMessageType.INFORMATION);
    ...
    {
        String data = "";
        xmlparser p = new xmlparser("configs/SYSMEX/SYSMEXXN1000.xml");
        try {
