...
/**
 * Client Connection on port 3600
 * @author Stevkkys
 */
...
public class MindrayBC3600 extends Thread 
{
    ...
    public void Stop()
    {
        try {
            ...
            welcomeSocket.close();
//            connSock.close();
             log.AddToDisplay.Display("Mindray BC-3600 handler stopped", DisplayMessageType.TITLE);
        } catch (IOException ex) {
            Logger.getLogger(MindrayBC3600.class.getName()).log(Level.SEVERE, null, ex);
        }
  		...
  		log.AddToDisplay.Display("Listening on port "+ tcpsettings.PORT+"...",DisplayMessageType.INFORMATION);
            ...
            else
            {
               ...
               connSock = new Socket(tcpsettings.EQUIPMENT_IP, tcpsettings.PORT);
                ...
                log.AddToDisplay.Display("Mindray BC-3600 is now Connected...",DisplayMessageType.INFORMATION);
                first=false;
                ClientThread client = new ClientThread(connSock,"Mindray BC-3600");
                client.start();
                String message ;
    ...
    {        
        xmlparser p = new xmlparser("configs/hl7/MindrayBC3600.xml");
        ...
        try {
            ...
            else if(MessageType.OBSERVE_RESULT.toString().equalsIgnoreCase(msg.type))
            {
                 ...
                 {
                   String pidParts[] = msgParts[3].split("\\|");
